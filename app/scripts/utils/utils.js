...
angular.module('mean').filter('si_no', function () {
...
angular.module('mean').directive('sgMaxDate', function () {
    return {
        require: 'ngModel',
...
angular.module('mean').service('SGDialog', ['$modal', function ($modal) {
    var dialog = {};
...
angular.module('mean').directive('sgReadOnly', function () {
    var disabled = {};
...
angular.module('mean').directive('sgInput', function () {
    var d = {
        scope: true,
        replace: false,
        link: function (scope, element, attrs) {
...
angular.module('mean').directive('sgEnter', function () {
...
angular.module('mean').directive('sgSave', ['$compile', function ($compile) {
    return {
        restrict: 'A',
...
angular.module('mean').directive('sgReset', ['$compile', function ($compile) {
    return {
        restrict: 'A',
        link: function ($scope, elem, attr, ctrl) {
...
angular.module('mean').directive('sgCancel', ['$compile', function ($compile) {
    return {
        restrict: 'A',
        link: function ($scope, elem, attr, ctrl) {
            elem.addClass('btn btn-default');
...
angular.module('mean').directive('sgDelete', ['$compile', function ($compile) {
    return {
        restrict: 'A',
        link: function ($scope, elem, attr, ctrl) {
...
angular.module('mean').filter('remove', function () {
